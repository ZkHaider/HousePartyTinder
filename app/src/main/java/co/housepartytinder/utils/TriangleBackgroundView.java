package co.housepartytinder.utils;
...
public class TriangleBackgroundView extends View {
    ...
    private static final int DEFAULT_PRIMARY        = Color.parseColor("#3174BF");
    private static final int DEFAULT_SECONDARY      = Color.parseColor("#4DA096");
    ...
    private void init() {
        ...
        mPaint.setColor(DEFAULT_SECONDARY);

        mBackgroundPaint = new Paint();
        mBackgroundPaint.setStyle(Paint.Style.FILL);
        mBackgroundPaint.setColor(DEFAULT_PRIMARY);
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            mForegroundColor = a.getColor(R.styleable.TriangleBackgroundView_foregroundColor, DEFAULT_SECONDARY);
            mBackgroundColor = a.getColor(R.styleable.TriangleBackgroundView_backgroundColor, DEFAULT_PRIMARY);
        } finally {
            if (a != null)
                a.recycle();
        }
